...
@section('content')
    ...
    <div class="portlet-background row">
        <div class="col-md-6 portlet" style="padding-right:10px;">
            <div class="portlet-title gray-bg round-corner">
                <label style="margin-left:0; margin-right:auto;margin-top:5px;">Thông tin</label>&nbsp&nbsp<span style="display:{{Auth::user()->hasAdminPermission()? '' : 'none'}}"><a href="/product/edit/{{$product->id}}"><i class="fa fa-edit"></i></a></span>
            </div>         
            <div class="portlet-body">
                ...
                <div class="row row-item justify-co">
                    ...
                    @else
                    <label class="col-lg-8 col-md-8 col-sm-8 col-8 redtext" style="text-align: center"><b>Đang bị khoá</b></label>
                    @endif
                </div>
    ...
    <div class="row justify-content-center" style="padding:15px; display:{{Auth::user()->hasAdminPermission()? '' : 'none'}}">
        <div>

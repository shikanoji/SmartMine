        ...
        <div class="col-md-6 portlet">
            ...
            <div class="portlet-body">
                <div class="row row-item">
                      ...
                      <label class="col-lg-6 col-md-6 col-sm-6 col-6 greentext" style="text-align: center">{{number_format($customer->getTaiKhoan(),0,',','.')}}</label>            
                </div>
                <div class="row row-item">
                ...
                <div class="row row-item">
                      ...
                      <label class="col-lg-6 col-md-6 col-sm-6 col-6 greentext" style="text-align: center">15</label>            
                </div>
            </div>
        </div>
    </div>
